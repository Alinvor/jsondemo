    ...
    return Mock.mock({
        'approvalInfo': {
            ...
            'data': {
                ...
                'appId': 'app_10007688',
                'approvalName': '测试审批3',
                'approvalDesc': '测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3测试审批3',
                'approvalType': '1',
                'approvalStatus': '2',
                'isDeleted': '0',
                'createrId': '10053408',
                ...
                'createValues': [
                        ...
                        'attachments|1-3': [
                            {
                                ...
                                'attachmentName': '测试附件3-1-1',
                                'attachmentAddress': 'http://www.baidu.com/a.xls',
                                'attachmentImgUrl': '@image(100x100)',
                                'attachmentImg': '@image()',
                            }
                        ]
                    },
                    {
                        ...
                        'attachments': [
                            {
                                'approvalAttachmentId': '2',
                                'attachmentName': '测试附件3-2-1',
                                'attachmentAddress': 'http://www.baidu.com/a.xls'
                            }
                        ]
                    }
